export default function TailwindBreakpointIndicator() {
	return (
		<div className="fixed right-0 bottom-0 m-2 flex items-center rounded border border-gray-400 bg-gray-300 p-2 text-pink-600 text-sm">
			<svg className="inline h-6 w-auto" viewBox="0 0 80 64" fill="none" xmlns="http://www.w3.org/2000/svg">
				<title> </title>
				<path
